...
namespace Day3
{
    class Program
    {
        ...
        {
            var wire1Coordinates = CalculateWireCoordinates(wire1path);
            var wire2Coordinates = CalculateWireCoordinates(wire2path);

            var commonCoordinates = new List<Coordinate>();//wire1Coordinates.Intersect(wire2Coordinates);//wire1Coordinates.Where(coordinate => wire2Coordinates.Contains(coordinate));
        ...
        private static List<Coordinate> CalculateWireCoordinates(string wirePath)
        {
            ...
            foreach(var move in wireMoves)
            {
                ...
                wireCoordinates.Add(new Coordinate(moveX, moveY));
                moveIndex++;
            }
